...
let AppComponent = (() => {
    let _classDecorators = [(0, core_1.Component)({
            selector: 'app-root',
            standalone: true,
            imports: [navbar_component_1.NavbarComponent, home_component_1.HomeComponent, about_component_1.AboutComponent, portfolio_component_1.PortfolioComponent, contact_component_1.ContactComponent, footer_component_1.FooterComponent],
